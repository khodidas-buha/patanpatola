<!DOCTYPE html>
<html lang="en">
<title>Visitors - PatanPatola</title>
      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li aria-current="page">
          <div class="inline-flex items-center">
            ...
            <a href="#"
              class="ml-1 text-sm font-medium text-gray-700 hover:text-red-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Visitors</a>
          </div>
        </li>
      </ol>
    </div>
            ...
            <div class="mt-16 sm:mt-32 lg:mt-32">
              <div
                ...
                <p class="text-sm text-white">
                 Visiting Patola loom at smithsonian folk life festival washing D.c. - 2002
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative p-4 sm:p-6 lg:p-8">
            ...
            <div class="  mt-16 sm:mt-32 lg:mt-32">
              <div
                class="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p class="text-sm text-white">
                Visiting patan patola during the shooting of khushbu Gujarat ki Feb. - 2012
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative p-4 sm:p-6 lg:p-8">
            ...
            <div class="  mt-16 sm:mt-32 lg:mt-32">
              <div
                class="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p class="text-sm text-white">
                Visiting patan patola Heriitage <br> 22-02-1987
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative p-4 sm:p-6 lg:p-8">
            ...
            <div class="  mt-16 sm:mt-32 lg:mt-32">
              <div
                class="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p class="text-sm text-white">
                Visiting patan patola Heriitage
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative p-4 sm:p-6 lg:p-8">
            ...
            <div class="  mt-16 sm:mt-32 lg:mt-32">
              <div
                class="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p class="text-sm text-white">
                Visiting patan patola Heriitage 12-03-2011
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative p-4 sm:p-6 lg:p-8">
            ...
            <div class="  mt-16 sm:mt-32 lg:mt-32">
              <div
                class="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p class="text-sm text-white">
                Visiting patan patola Heriitage 28-05-1999
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative p-4 sm:p-6 lg:p-8">
            ...
            <div class="  mt-16 sm:mt-32 lg:mt-32">
              <div
                class="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p class="text-sm text-white">
                Visiting patan patola Heriitage 04-03-2010
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative p-4 sm:p-6 lg:p-8">
            ...
            <div class="  mt-16 sm:mt-32 lg:mt-32">
              <div
                class="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p class="text-sm text-white">
                Visiting patan patola Exhibition at Delhi
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative p-4 sm:p-6 lg:p-8">
            ...
            <div class="  mt-16 sm:mt-32 lg:mt-32">
              <div
                class="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p class="text-sm text-white">
                Visiting patan patola Heriitage 18-10-2012
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative p-4 sm:p-6 lg:p-8">
            ...
            <div class="  mt-16 sm:mt-32 lg:mt-32">
              <div
                class="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p class="text-sm text-white">
                Visiting patan patola Heriitage 23-05-2012
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative p-4 sm:p-6 lg:p-8">
            ...
            <div class="  mt-16 sm:mt-32 lg:mt-32">
              <div
                class="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p class="text-sm text-white">
                Visiting patan patola Heriitage 28-01-2012
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative p-4 sm:p-6 lg:p-8">
            ...
            <div class="  mt-16 sm:mt-32 lg:mt-32">
              <div
                class="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p class="text-sm text-white">
                Visiting patan patola Heriitage 17-04-2012
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative p-4 sm:p-6 lg:p-8">
            ...
            <div class="  mt-16 sm:mt-32 lg:mt-32">
              <div
                class="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p class="text-sm text-white">
                Visiting patan patola Heriitage 03-06-1997
                </p>
              </div>
            </div>
          </div>
