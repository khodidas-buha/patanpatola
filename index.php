...
<body>
  ...
  <section>
    <div class="container mx-auto pt-20 pb-8 md:pt-16 md:pb-5 md:pb-0">
      <div class="text-center">
        <h2 class="text-red-950 font-bold text-3xl md:text-4xl capitalize mb-4">
          Sarees
        </h2>
        <p class="text-gray-600 text-base md:text-lg text-center mb-4">Patan Patola is a hand-woven saree made
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 gap-12">
        <div class="grid gap-12">
          ...
          <div>
            <img class="h-auto max-w-full rounded-lg" src="src/img/saree2.png" alt="">
          </div>
          <div>
        ...
        <div class="grid gap-12">
          ...
          <div>
            <img class="h-auto max-w-full rounded-lg" src="src/img/saree5.png" alt="">
          </div>
          <div>
        ...
        <div class="grid gap-12">
          ...
          <div>
            <img class="h-auto max-w-full rounded-lg" src="src/img/saree8.png" alt="">
          </div>
          <div>
      ...
      <div class="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
        <div class="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
          ...
          <p class="pr-5 mb-5 text-base text-gray-700 md:text-lg">
            Embark on a captivating exploration of the rich heritage and intricate craftsmanship behind sari making.
            Discover the ancient techniques, vibrant textiles, and cultural significance woven into each fold, as you
