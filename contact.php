    ...
    <section class="relative z-10 overflow-hidden bg-white py-20 lg:py-[120px]">
        <div class="container mx-auto">
            <div class="-mx-4 flex flex-wrap lg:justify-between">
                <div class="w-full px-8 lg:w-1/2 xl:w-6/12">
                    <div class="mb-12 max-w-[570px] lg:mb-0">
                        <h2
                            class="text-red-900 mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                            ...
                            <div class="mb-8 flex w-full max-w-[370px]">
                                ...
                                <div class="w-full">
                                    ...
                                    <p class="text-body-color text-base">
                                        Opp. New Kalika Temple, <br> Rani ki Vav road,<br>
                                        Patan (N.Guj.) 384265
                                    </p>
                                </div>
                            </div>
                ...
                <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                    <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                        <form action="https://form.webmavens.com/" enctype="multipart/form-data" method="post"
                            name="contacts" class="request-form">
                            <input type="hidden" name="toemail" value="6B686F6469646173407765626D6176656E732E636F6D">
                            <input type="hidden" name="bccemail" value="6B686F6469646173407765626D6176656E732E636F6D">
                            <input type="hidden" name="subject" value="contacts - {sub} - {name}  ">
                            <!-- <input type="hidden" name="return_url"
                                value="https://mittalfurniture-in.webmavens.com/thanks.php"> -->
                            <!-- <input type="hidden" name="captcha_logo"
                                value="https://mittalfurniture-in.webmavens.com/images/logo.png?validation=1"> -->
                            <!-- <input type="hidden" name="auto_response_url"
                                value="https://mittalfurniture-in.webmavens.com/thanks-response.html"> -->
                            <div class="mb-6">
                                <input type="text" placeholder="Your Name" name="name"
                                    class="text-body-color border-red-900 focus:border-red-900 w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none placeholder-red-900" />
                            </div>
                            <div class="mb-6">
                            ...
                            <div class="mb-6">
                                <textarea rows="6" placeholder="Your Message" name="message"
                                    class="text-body-color border-red-900 focus:border-red-900 w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none placeholder-red-900"></textarea>
                            </div>
                            <div>
                                <button type="submit"
                                    class="bg-red-900 border-red-100 w-full rounded border p-3 text-white transition hover:bg-opacity-90">
                                    Send Message
                                </button>
                            </div>
                        </form>
